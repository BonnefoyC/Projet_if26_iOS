...
public class Logement : NSObject, MKAnnotation {
    ...
    static func getinitiallogement()-> [Logement]{
        var list: [Logement] = [Logement(label:"Loue studio spacieux et lumineux",description:"grands placards cuisine équipée, salle de bain avec sèche serviette et WC séparé.", prix:380, nb_pieces:1,ville:"Troyes",adresse:"4 Rue Brunneval",lat:48.3138335, lng:4.107648, id_proprio:"1"),
                                ...
                                Logement(label:"Grand Studio",description:"Dans un petit immeuble ancien, au premier étage sans ascenseur, grand studio refait à neuf, comprenant: spacieuse pièce avec cuisine ouverte, salle d’eau avec Wc. Petite cour. Rue calme.", prix:700, nb_pieces:1 ,ville:"10000Troyes",adresse:"9 Rue Jean Neveu",lat:48.300133, lng:4.112111, id_proprio:"4"),
                                Logement(label:"Joli et lumineux appartement",description:"Ce studio est très lumineux et cosy. Il se trouve au 7ème étage avec ascenseur dans une résidence sécurisée (place de parking disponible). ", prix:750, nb_pieces:3,ville:"10000 Troyes",adresse:"4 Rue Sancey",lat:48.306753, lng:4.092904, id_proprio:"5"),
                                ...
                                Logement(label:"Beau F4",description:"Appartement lumineux proche centre-ville, commerces, écoles, troisième étage sans ascenseur. Entrée, cuisine indépendante, aménagée et équipée (hotte, four plaque vitro), 2 chambres séparées par salle de bain (baignoire) et WC, séjour, salon. Sol carrelé, volets roulants et fenêtres double vitrage, placards.", prix:630, nb_pieces:4,ville:"10000 Troyes",adresse:"7 Rue Preize",lat:48.255854, lng:4.074708, id_proprio:"9"),
